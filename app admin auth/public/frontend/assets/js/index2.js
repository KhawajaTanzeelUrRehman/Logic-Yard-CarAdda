function survey () {
	...
	new Morris.Donut({
		...
		colors: [myVarVal, myVarVal1, '#05a01f','#0b7eb7'],
...
function lineChart1 () {
	var ctx = document.getElementById("lineChart1");
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					borderWidth: "5",
					backgroundColor: hexToRgba(myVarVal1, 0.6),
		...
		gradientStroke1.addColorStop(0, hexToRgba(myVarVal, 0.0));
		var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
		gradientStroke2.addColorStop(0, hexToRgba(myVarVal1, 0.0));
		var myChart = new Chart(myCanvas, {
			type: 'line',
			data: {
