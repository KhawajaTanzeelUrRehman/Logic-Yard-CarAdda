                                ...
                                <div class="form-container">
                                  ...
                                  <form action="">
                                    ...
                                    <div class="form-group">
                                        <h4 class="page-title s3">Countries</h4>
                                    ...
                                    <div class="form-group">
                                        <label class="card-title s3">Countries Code*</label>
                                        <input class="form-control" type="text" placeholder="Enter Countries Code" required=""/>
                                      </div>
