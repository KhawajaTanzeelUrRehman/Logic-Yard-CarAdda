...
<div class="app-content">
    <div class="side-app">
        <div class="page-header">
            <h4 class="page-title">Car Type</h4>
            <ol class="breadcrumb">
                                ...
                                <div class="form-container">
                                  ...
                                  <form action="{{route('cartype.store')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <h4 class="page-title s3">Car Type</h4>
...
@endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('cartype.destroy',$cartype->id) }}" method="POST">
                                                ...
                                                {{-- <a class="btn btn-info" href="{{ route('cartypes.show',$cartype->id )}}">Show</a> --}}
                ...
                <div class="row">
                        ...
                        <div class="from-group">
                            <strong>NAME</strong>
                            <input type="text" name="name" value="{{ $cartype->name }}" class="form-control" placeholder="Enter Name">
                        </div>

                        <div class="from-group">
                            <strong>SLUG</strong>
                            <input type="text" name="slug" value="{{ $cartype->slug }}" class="form-control" placeholder="Enter slug">
                        </div>
