...
$('.budget-control').prop('checked', true);
$('.model-control').prop('checked', false);
...
$('select.by-model').val('null').trigger('change');
$('select.by-budget').val('null').trigger('change');
$('.budget-label').click(function(){
	$('select.by-model').val('null').trigger('change');
});
$('.model-label').click(function(){
	$('select.by-budget').val('null').trigger('change');
});
